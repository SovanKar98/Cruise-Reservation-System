...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<title>Cruise Ticket Reservation</title>
...
<a class="navbar-brand" href="index.html">Cruise<span class="themecolor"> T</span>ickets</a>
...
<li><a href="#con" class="page-scroll"><h3>Contact</h3></a></li>
...
<h1 class="main-heading-title" style="color:cyan;">CRUISE TICKET</h1>

<h1 class="main-heading-title" style="color:deepskyblue;">RESERVATION SYSTEM</span></h1>

<p class="main-heading-text">WELCOME TO,<br/>CRUISE TICKET RESERVATION SYSTEM</p>
...
<section class="main-heading" id="con">
...
<h1 class="main-heading-title">Developed By : </h1>

<div class="btn-bar">

<a href="#" class="btn btn-custom theme_background_color">Sovan Kar<br>Ph. No.- 790812401<br>Email-iamsovankar@gmail.com</a>
